...
from read_data import XQAQuestion
...
Modified from docqa/triviaqa/answer_detection.py
"""
...
def compute_answer_spans(questions: List[XQAQuestion], corpus, word_tokenize,
                         detector):
    ...
    for i, q in enumerate(questions):
        ...
        if q.answer is None:
            continue
        tokenized_aliases = [word_tokenize(x) for x in q.answer.all_answers if x]
...
def compute_answer_spans_par(questions: List[XQAQuestion], corpus,
